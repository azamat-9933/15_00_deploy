...
class ServiceDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Service
        fields = ('id', 'title', 'subtitle', 'image', 'for_what', 'short_desc',
                  'desc', 'price', 'category', 'images', 'characteristics',
                  'procedure_costs', 'who_performs_procedures')
        read_only_fields = fields
...
class SpecialistDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Specialist
        fields = ('id', 'full_name', 'position', 'about', 'certificates', 'photo',
                  'experience_in_company', 'experience_in_field', 'experience_in_years',
                  'procedures', 'diplomas')
        read_only_fields = fields
